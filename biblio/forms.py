...
class AuthorForm(forms.ModelForm):
    ...
    class Meta:
        ...
        error_messages = {
            'first_name': {
                ...
                'min_length': _('Le prénom doit contenir au moins 2 caractères'),
                'max_length': _('Le prénom ne doit pas dépasser 100 caractères')
            },
            'last_name': {
    ...
    def clean_first_name(self):
        ...
        if first_name:
            ...
            if len(first_name) < 2:
                raise forms.ValidationError(
                    _('Le prénom doit contenir au moins 2 caractères')
                )
        return first_name
